      ...
      case "FILTER_DATA":
        ...
        if (value.length) {
          filteredData = state.allData
            .filter(item => {
              let startsWithCondition = item.vehicle_details && (
                item.vehicle_details.make.toLowerCase().startsWith(value.toLowerCase()) ||
                item.vehicle_details.model.toLowerCase().startsWith(value.toLowerCase()) ||
                item.vehicle_details.plateNumber.toLowerCase().startsWith(value.toLowerCase()))
  
              let includesCondition = item.vehicle_details && (
                item.vehicle_details.make.toLowerCase().includes(value.toLowerCase()) ||
                item.vehicle_details.model.toLowerCase().includes(value.toLowerCase()) ||
                item.vehicle_details.plateNumber.toLowerCase().includes(value.toLowerCase()))
